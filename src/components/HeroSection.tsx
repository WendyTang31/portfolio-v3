...
export function HeroSection() {
  return (
    <section className="relative flex w-full flex-col overflow-hidden bg-[#f7f6f3]">
      ...
      <div className="relative z-20 flex flex-col px-6 pb-8 pt-6 md:px-16 md:pb-10 md:pt-7">
        <motion.div
        ...
        >
          ...
          <div className="mt-5 flex flex-col items-start justify-between gap-5 md:mt-6 md:flex-row md:items-end">
            <motion.p
              variants={fadeUp}
              transition={{ duration: 0.8, ease: "easeOut" }}
              className="text-hero-subline max-w-3xl text-[#4a4a48]"
            >
            ...
            <motion.a
              variants={fadeUp}
              href="#work"
              className="group relative inline-flex shrink-0 items-center gap-3 overflow-hidden rounded-md border border-[#1a1a1a] bg-[#1a1a1a] px-5 py-2.5 text-[14px] font-medium text-white shadow-sm transition-transform hover:-translate-y-px hover:shadow-[3px_3px_0px_rgba(17,17,17,0.5)] active:translate-y-0 active:shadow-sm"
            >
        ...
        <motion.div
          ...
          className="mt-8 grid grid-cols-2 gap-5 border-t border-gray-300/70 pt-6 md:grid-cols-4 md:gap-8 md:pt-7"
        >
          {SITE.skills.map((skill) => (
            ...
            >
              ...
              <h3 className="mt-1.5 text-base font-medium tracking-tight text-[#111] md:text-lg">
                {skill.label}
              </h3>
